...
namespace BlockchainAssignment
{
    public partial class BlockchainApp : Form
    {
        ...
        {
            // creates the initial componests of the UI 
            InitializeComponent();
            // starts a  new blockchain 
            blockchain = new Blockchain();
            // displays the initalisation message
        ...
        /* WALLETS */
        // this is used to create a new Wallet and provide public and private key fields 
        ...
        // the keys must be authenticated by comparing the mathematical relationship
        ...
        // a pending transaction is established and added to the transaction pool
        ...
        /* BLOCK MANAGEMENT */
        // Proof-of-work must be initialised to mine transactions from the pool and submit a new block to the Blockchain
        private void NewBlock_Click(object sender, EventArgs e)
        {
            // pending transactions are retrieved and added to the newly generated Block
            List<Transaction> transactions = blockchain.GetPendingTransactions();

            // the newly created block is and appended - requires a reference to the previous block, a set of transactions and the miners public address  
