...
{
    /// <summary>
    /// the code for generating key pairs and signatures, and validating signatures and private keys is below
    /// </summary>
    class Wallet
    {
        ...
        /// <summary>
        /// checks if a signiture is valid
        /// the ID of the wallet making the transaction is publicID
        /// the hash of transaction is datahash 
        /// the hash created by the private key and datahash is datasig 
        /// the above paramters can be used to authenticate the datasig 
        /// </summary>
